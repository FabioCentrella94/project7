    ...
    <div class="uploadContainer">
      ...
      <div class="uploadfilecontainer">
        ...
        <input
          ...
          type="file"
          name="file"
          @change="validateFileInput($event), previewFile($event)"
        />
        <img id="imagepreview" />
      </div>

      <button type="submit" @click.prevent="uploadFile($event)" disabled>
        Upload
      </button>
    </div>
  </form>
...
export default {
  ...
  methods: {
    ...
    uploadFile() {
      ...
      axios
        .post(
          "https://project7-backend.myportfolio.training/api/post",
          formData,
          {
            headers: {
